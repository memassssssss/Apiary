...
const modesData = [
    {
        ...
        badges: ["1.21.1", "Платный", "Без грифа"],
        features: ["Масштабные ивенты", "Строгий анти-гриф", "Внутренние суды", "Живая экономика"],
        plugins: ["PlasmoVoice", "CoreProtect", "GSit", "Emotecraft"],
    ...
    {
        title: "Apiary Mini",
        desc: "Сервер для всех желающих! Здесь разрешено ПВП, но классический гриф запрещен. Идеально для старта и отдыха с неповторимым ламповым вайбом.",
        render: "./img/mini_render.png", 
        badges: ["1.21.1", "Бесплатный", "Вайт-лист"],
        features: ["Легкий старт", "ПВП разрешено", "Донат через ТГ-бота", "Ламповое комьюнити"],
        plugins: ["Essentials", "SimpleTpa", "Анти-чит", "PlasmoVoice"],
    ...
    },
    {
        ...
        badges: ["1.21.1", "Хардкор", "Гриф разрешен"],
        features: ["Полный хаос", "Разрешен гриф", "Жесткое ПВП", "Без пощады"],
